...
class _EmployeeAttendanceScreenState extends State<EmployeeAttendanceScreen> {
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            backgroundColor: AppColors.info, // Energetic Cobalt Blue
  ...
  Widget _statusChip(String status) {
    ...
    if (status == "Present") color = AppColors.green;
    if (status == "Absent") color = AppColors.red;
    if (status == "Leave") color = AppColors.orange;
