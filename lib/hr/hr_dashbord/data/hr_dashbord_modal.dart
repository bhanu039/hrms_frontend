class HrDashboardModel {
  ...
  factory HrDashboardModel.fromJson(Map<String, dynamic>? json) {
    ...
    return HrDashboardModel(
      ...
      selfAttendance:data["selfAttendance"]!=null?SelfAttendance.fromJson(data["selfAttendance"]):null,
...
class SelfAttendance {
  ...
  SelfAttendance({required this.status, this.checkInTime, this.checkOutTime});
