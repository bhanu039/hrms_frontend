...
class SessionService {
  ...
  static Future<void> saveSession({
    ...
    await _storage.write(
      key: "isFullRegistered",
      value: (user["isFullRegistered"] ?? false).toString(),
    );
  }
  ...
  static Future<bool> getisFullRegistered() async {
    final value = await _storage.read(key: "isFullRegistered");

    return value == "true";
  }

  static Future<void> isFullRegisteredupdate(bool value) async {
    await _storage.write(key: "isFullRegistered", value: value.toString());
  }


static const String _key = "working_duration";
  ...
  // ✅ Get duration
  static Future<Duration> get() async {
