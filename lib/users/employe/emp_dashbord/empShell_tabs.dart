...
class Empshell extends StatelessWidget {
  ...
  int _index(BuildContext context) {
    ...
    if (path.startsWith('/emp/attendance/self')) return 2;
    if (path.startsWith('/emp/projects')) return 3;
    if (path.startsWith('/emp/profile')) return 4;
  ...
  void _onTap(BuildContext context, int i) {
    switch (i) {
      ...
      case 1:
        context.go('/emp/attendance/self');
        break;
      case 2:
