...
class _EmployeeProjectScreenState extends State<EmployeeProjectScreen>
  ...
  final List<String> teamMembers = ["John", "David", "Sarah", "Alex"];
  ...
  final List<Map<String, String>> activities = [
    {"date": "12 May 2026", "message": "Login module completed successfully."},
    {"date": "15 May 2026", "message": "Backend APIs integrated."},
    {"date": "20 May 2026", "message": "Dashboard development started."},
  ];
  @override
  void initState() {
    super.initState();
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                   Row(
                    children: [
                      Icon(Icons.folder_copy, color: AppColors.indigo),
                      SizedBox(width: 10),
                      Text(
                        "CRM Mobile App",
                        style: TextStyle(
                  ...
                  const Row(
                    ...
                    children: [Text("Client"), Text("ABC Technologies")],
                  ),
                  ...
                  const Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Start Date"), Text("01 May 2026")],
                  ),
                  const SizedBox(height: 10),
                  const Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Deadline"), Text("30 Jun 2026")],
                  ),
  ...
  Widget buildFilesTab() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Card(
          child: ListTile(
            leading:  Icon(Icons.picture_as_pdf, color: AppColors.red),
  ...
  Widget buildActivityTab() {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Card(
          child: ListTile(
            leading:  Icon(Icons.history, color: AppColors.indigo),
