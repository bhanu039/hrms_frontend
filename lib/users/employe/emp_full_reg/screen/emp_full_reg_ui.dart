...
class _EmployeeOnboardingScreenState extends State<EmployeeOnboardingScreen> {
  String? role;
  initState() {
    role = context.read<AuthBloc>().state.session?.role;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<EmpFullRegBloc, EmpFullRegState>(
      ...
      builder: (context, state) {
        return Scaffold(
          backgroundColor: AppColors.adminSoftBg,
          ...
          return Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: i <= step ? AppColors.indigo : AppColors.grey.shade300,
            ...
            child: CustomTextField(
              ...
              onTap: () async {
                ...
                if (pickedDate != null) {
                  ...
                  context.read<EmpFullRegBloc>().add(
                    UpdateField("startYear", formatted),
                  );
                }
              },
              onChanged: (value) {
          ...
          ? Column(
              children: [
                ...
                CustomTextField(
                  label: "Company name",
                  prefixIcon: const Icon(Icons.account_balance),
                  initialValue: state.model.companyName,
                  onChanged: (value) {
                    context.read<EmpFullRegBloc>().add(
