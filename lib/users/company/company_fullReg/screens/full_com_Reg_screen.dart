...
import 'package:goexperts/users/company/company_fullReg/bloc/full_Reg_state.dart';
...
class _CompanyRegistrationPageState extends State<CompanyRegistrationPage> {
    ...
    return _card("Basic Information", [
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
              color: state.model.companyLogo == null ? AppColors.red : AppColors.grey,
            ),
      ...
      GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(
              color: state.model.signature == null ? AppColors.red : AppColors.grey,
            ),
            borderRadius: BorderRadius.circular(12),
          ),
  ...
  Widget _step2(BuildContext context, FullRegState state) {
    return _card("HR Settings", [
      ...
      CustomTextField(
        ...
        initialValue: state.model.termsAndConditions,
        minLines: 4,
        maxLines: 40,
  ...
  Widget _step4(BuildContext context, FullRegState state) {
   bool? islocation = false;
    return _card("Office Address", [
        ...
        child:Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [AppColors.indigo.shade500, AppColors.indigo.shade300],
            ),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.map, color: AppColors.white, size: 30),
              ),
              ...
              const SizedBox(width: 15),
               ...
               Expanded(
                child: Column(
                  ...
                  children: [
                  islocation!? const CircularProgressIndicator(
                strokeWidth: 2.5,
      ...
      CustomTextField(
        label: "GeofencRadius",
        initialValue: state.model.geofenceRadius?.toString() ?? "",
        hintText: "Enter GeofencRadius in meters of your company",
        keyboardType: TextInputType.number,
        onChanged: (value) {
          print("Geofence Radius changed: $value");
  ...
  Widget _preview(BuildContext context, FullRegState state) {
    ...
    return _card("Preview", [
      ...
      _previewText("Geofence Radius", m.geofenceRadius?.toString() ?? "-"),
      ...
      _previewText("terms", m.termsAndConditions ?? "-"),
