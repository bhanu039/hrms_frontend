  ...
  void _onUpdateField(UpdateField event, Emitter<FullRegState> emit) {
    ...
    switch (event.key) {
      ...
      case "longitude":
        ...
        break;
      case "geofenceRadius":
        updated = m.copyWith(geofenceRadius: int.tryParse(event.value.toString()));
         print("geofenceRadius ::::$updated");
        break;
      ...
      case "termsAndConditions ":
        updated = m.copyWith(termsAndConditions: event.value);
        break;
      ...
      case "pfRegistrationNumber":
        updated = m.copyWith(pfRegistrationNumber: event.value);
        break;
      ...
      case "esiRegistrationNumber":
        updated = m.copyWith(esiRegistrationNumber: event.value);
        break;

      case "ptRegistrationNumber":
        updated = m.copyWith(ptRegistrationNumber: event.value);
        break;
      ...
      case "payrollStartDay":
        updated = m.copyWith(payrollStartDay: event.value);
        break;

      case "payrollEndDay":
        updated = m.copyWith(payrollEndDay: event.value);
        break;

      case "termsAndConditions":
        updated = m.copyWith(termsAndConditions: event.value);
         print("termsAndConditions ::::$updated");
        break;
      ...
      case "regCertificate":
        updated = m.copyWith(regCertificate: event.value);
        break;
